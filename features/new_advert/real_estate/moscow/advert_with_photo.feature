  ...
  Сценарий: Подача объявления с фотографией
   Когда я вхожу под пользователем с ролью "Доверенный интернет-партнер"
    ...
    Когда я подаю объявление в категорию "Недвижимость -> Квартиры. Продажа -> Вторичный рынок" с параметрами:
       ...
       * в ЛК ИП объявление с названием "5-комн. квартира, Интернациональная улица, 10, 5 общая 500 кв. м., приватизированная" присутствует в списке
...
@advert_submit
  Сценарий: Проверка деталей поданного объявления
    Когда я вхожу под пользователем с ролью "Доверенный интернет-партнер"
       ...
       То в ЛК ИП объявление с названием "5-комн. квартира, Интернациональная улица, 10, 5 общая 500 кв. м., приватизированная" присутствует в списке
...
@after_index
  Сценарий: Проверка индексации
   Когда на главной странице я перехожу в категорию "Недвижимость -> Квартиры. Продажа -> Вторичный рынок"
       ...
       * в списке обычных объявлений присутствует объявление "5-комн. квартира, Интернациональная улица, 10, 5 общая 500 кв. м., приватизированная"
