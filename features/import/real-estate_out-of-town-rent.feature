...
Функционал: Импорт в категорию Недвижимость > Дома, дачи, участки. Аренда
  ...
  Сценарий: Импорт объявления в Петербург c метро Адмиралтейская
    Когда я обновляю и импортирую файл "real-estate_out-of-town-rent/scenario5.xml" для роли "Пользователь для импорта"
    ...
    Когда я открываю детали этого объявления
       То в деталях объявления категории "Недвижимость -> Дома, дачи, участки. Аренда" "Станция метро" равно "Адмиралтейская"
