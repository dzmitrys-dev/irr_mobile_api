# language:ru
# encoding: utf-8
Функционал: Оборудование -> Пищевое

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Оборудование -> Пищевое"
...
@customfield
  Сценарий: Фильтр по типу оборудования
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value       |
      | Тип оборудования | холодильное |
      И на странице поиска загружен список результатов

      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Тип оборудования" равно "холодильное"
