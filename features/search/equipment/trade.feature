...
Функционал: Оборудование -> Торговое и холодильное оборудование
  ...
  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Оборудование -> Торговое и холодильное оборудование"
...
@customfield
  Сценарий: Фильтр по типу оборудования 1
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value                                      |
      | Тип оборудования | Другое торговое и холодильное оборудование |
      И на странице поиска загружен список результатов
...
@customfield
  Сценарий: Фильтр по типу оборудования 2
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value               |
      | Тип оборудования | Торговые сооружения |
      И на странице поиска загружен список результатов
...
@customfield
  Сценарий: Фильтр по типу оборудования 3
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value           |
      | Тип оборудования | Детекторы валют |
      И на странице поиска загружен список результатов
...
@customfield
  Сценарий: Фильтр по типу оборудования 4
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value         |
      | Тип оборудования | Торговые весы |
      И на странице поиска загружен список результатов
...
@customfield
  Сценарий: Фильтр по типу оборудования 5
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value              |
      | Тип оборудования | Штрих-код сканнеры |
      И на странице поиска загружен список результатов
...
@customfield
  Сценарий: Фильтр по типу оборудования 6
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value                                       |
      | Тип оборудования | Оборудование для упаковки пищевых продуктов |
      И на странице поиска загружен список результатов
...
@customfield
  Сценарий: Фильтр по типу оборудования 7
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value          |
      | Тип оборудования | Cчетчики купюр |
      И на странице поиска загружен список результатов
...
@customfield
  Сценарий: Фильтр по типу оборудования 8
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value               |
      | Тип оборудования | Платёжные терминалы |
      И на странице поиска загружен список результатов

      То на странице показано >= 1 объявлений

@customfield
  Сценарий: Фильтр по типу оборудования 9
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value             |
      | Тип оборудования | Торговые автоматы |
      И на странице поиска загружен список результатов

      То на странице показано >= 1 объявлений

@customfield
  Сценарий: Фильтр по типу оборудования 10
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value                    |
      | Тип оборудования | Холодильное оборудование |
      И на странице поиска загружен список результатов

      То на странице показано >= 1 объявлений

@customfield
  Сценарий: Фильтр по типу оборудования 11
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value             |
      | Тип оборудования | Кассовые аппараты |
      И на странице поиска загружен список результатов

      То на странице показано >= 1 объявлений

@customfield
  Сценарий: Фильтр по типу оборудования 12
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value          |
      | Тип оборудования | Принтеры чеков |
      И на странице поиска загружен список результатов
