...
Функционал: Оборудование -> Станки, производственное и обрабатывающее оборудование
  ...
  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Оборудование -> Станки, производственное и обрабатывающее оборудование"
...
@customfield
  Сценарий: Фильтр по типу оборудования 2
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value   |
      | Тип оборудования | Оборудование по утилизации и переработке |
      И на странице поиска загружен список результатов
...
@customfield
  Сценарий: Фильтр по типу оборудования 3
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value   |
      | Тип оборудования | Оборудование для полиграфии |
      И на странице поиска загружен список результатов
...
@customfield
  Сценарий: Фильтр по типу оборудования 4
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value   |
      | Тип оборудования | Оборудование для промышленной упаковки |
      И на странице поиска загружен список результатов
...
@customfield
  Сценарий: Фильтр по типу оборудования 5
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value   |
      | Тип оборудования | Металлообрабатывающие станки |
      И на странице поиска загружен список результатов
...
@customfield
  Сценарий: Фильтр по типу оборудования 6
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value   |
      | Тип оборудования | Оборудование для промышленной пищевой обработки |
      И на странице поиска загружен список результатов
...
@customfield
  Сценарий: Фильтр по типу оборудования 7
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value   |
      | Тип оборудования | Деревообрабатывающие станки |
      И на странице поиска загружен список результатов
