# language:ru
# encoding: utf-8
Функционал: Компьютерная техника -> Расходные материалы -> Другое

  Контекст:
    Когда открыта страница для города "Москва"
        И на главной странице я перехожу в категорию "Компьютерная техника -> Расходные материалы -> Другое"
