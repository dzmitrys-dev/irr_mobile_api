# language:ru
# encoding: utf-8
Функционал: Компьютерная техника -> Источники питания -> Сетевые фильтры и стабилизаторы

  Контекст:
    Когда открыта страница для города "Москва"
        И на главной странице я перехожу в категорию "Компьютерная техника -> Источники питания -> Сетевые фильтры и стабилизаторы"
