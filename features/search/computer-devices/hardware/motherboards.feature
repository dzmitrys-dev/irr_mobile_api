# language:ru
# encoding: utf-8
Функционал: Компьютерная техника -> Комплектующие -> Материнские платы

  Контекст:
    Когда открыта страница для города "Москва"
        И на главной странице я перехожу в категорию "Компьютерная техника -> Комплектующие -> Материнские платы"
...
@customfield
  Сценарий: Фильтр по производителям процессора
   Когда я делаю поиск по следующим параметрам:
      | parameter                | value |
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Производитель процессора" равно "Intel"
