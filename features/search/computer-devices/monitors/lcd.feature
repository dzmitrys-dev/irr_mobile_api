# language:ru
# encoding: utf-8
Функционал: Компьютерная техника -> Мониторы -> LCD (ЖК)

  Контекст:
    Когда открыта страница для города "Москва"
        И на главной странице я перехожу в категорию "Компьютерная техника -> Мониторы -> LCD (ЖК)"
...
@customfield
  Сценарий: Фильтр по диагонали
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Диагональ экрана" >= "15"
       И в деталях первого объявления "Диагональ экрана" <= "22"
