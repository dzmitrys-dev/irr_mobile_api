# language:ru
# encoding: utf-8
Функционал: Компьютерная техника -> Flash-накопители -> Кард-ридеры

  Контекст:
    Когда открыта страница для города "Москва"
        И на главной странице я перехожу в категорию "Компьютерная техника -> Flash-накопители -> Кард-ридеры"
