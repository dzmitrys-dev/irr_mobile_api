# language:ru
# encoding: utf-8
Функционал: Компьютерная техника -> Flash-накопители -> USB flash-диски

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Компьютерная техника -> Flash-накопители -> USB flash-диски"
