# language:ru
# encoding: utf-8
Функционал: Компьютерная техника -> Мультимедиа -> Оборудование для видеоконференций

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Компьютерная техника -> Мультимедиа -> Оборудование для видеоконференций"
