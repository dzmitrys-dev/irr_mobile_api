# language:ru
# encoding: utf-8
Функционал: Электроника и техника -> Кухонная техника -> Посудомоечные машины

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Электроника и техника -> Кухонная техника -> Посудомоечные машины"
...
@bugs @bugs34002
  Сценарий: Фильтр по объему загрузки
    Когда я делаю поиск по следующим параметрам:
      | parameter                  | value |
      | Объем загрузки, комплектов | 10-14 |
      И на странице поиска загружен список результатов

      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Объем загрузки, комплектов" равно "10-14"
