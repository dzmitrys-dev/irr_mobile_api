# language:ru
# encoding: utf-8
Функционал: Электроника и техника -> Стиральные машины -> Стиральные машины

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Электроника и техника -> Стиральные машины -> Стиральные машины"
...
@customfield
  Сценарий: Фильтр по типу загрузки
    Когда я делаю поиск по следующим параметрам:
      | parameter    | value       |
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Тип загрузки" равно "фронтальная"

@customfield
  Сценарий: Фильтр по объему загрузки
    Когда я делаю поиск по следующим параметрам:
      | parameter          | value |
      | Объем загрузки, кг | 4     |
      И на странице поиска загружен список результатов
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Объем загрузки, кг" равно "4"

@customfield
  Сценарий: Фильтр по сушке
    Когда я делаю поиск по следующим параметрам:
      | parameter | value |
      | Сушка     | x     |
      И на странице поиска загружен список результатов
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления присутствует "Сушка"

@customfield
  Сценарий: Фильтр по встраиваемой технике
    Когда я делаю поиск по следующим параметрам:
      | parameter            | value |
      | Встраиваемая техника | x     |
      И на странице поиска загружен список результатов

      То на странице показано >= 1 объявлений
       И в деталях первого объявления присутствует "Встраиваемая техника"
