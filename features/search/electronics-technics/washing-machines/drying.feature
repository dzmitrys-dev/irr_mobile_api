# language:ru
# encoding: utf-8
Функционал: Электроника и техника -> Стиральные машины -> Сушильные машины

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Электроника и техника -> Стиральные машины -> Сушильные машины"
...
@customfield
  Сценарий: Фильтр по объему загрузки
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Объем загрузки" равно "2-3"

@bugs @bug_missing_photos
