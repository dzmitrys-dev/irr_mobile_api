...
@customfield
  Сценарий: Фильтр по количеству датчиков
    Когда я делаю поиск по следующим параметрам:
      | parameter               | min | max |
      | Количество датчиков, шт | 1   | 100 |
      И на странице поиска загружен список результатов

      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Количество датчиков, шт" >= "1"
       И в деталях первого объявления "Количество датчиков, шт" <= "100"

  Сценарий: Фильтр по количеству датчиков
    Когда я делаю поиск по следующим параметрам:
      | parameter               | max     |
      | Количество датчиков, шт | 1000000 |
      И на странице поиска загружен список результатов
...
@customfield
  Сценарий: Фильтр по расстоянию до препятствия
    Когда я делаю поиск по следующим параметрам:
      | parameter                    | min | max |
      | Расстояние до препятствия, м | 1   | 100 |
      И на странице поиска загружен список результатов

      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Расстояние до препятствия, м" >= "1"
       И в деталях первого объявления "Расстояние до препятствия, м" <= "100"

@customfield
  Сценарий: Фильтр по расстоянию до препятствия
    Когда я делаю поиск по следующим параметрам:
      | parameter                    | max     |
      | Расстояние до препятствия, м | 1000000 |
      И на странице поиска загружен список результатов
