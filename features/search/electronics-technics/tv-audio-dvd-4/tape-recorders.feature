# language:ru
# encoding: utf-8
Функционал: Электроника и техника -> Аудио, Видео -> Магнитолы

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Электроника и техника -> Аудио, Видео -> Магнитолы"
...
@customfield
  Сценарий: Фильтр по типу магнитолы
    Когда я делаю поиск по следующим параметрам:
      | parameter     | value |
      | Тип магнитолы | MP3   |
      И на странице поиска загружен список результатов
