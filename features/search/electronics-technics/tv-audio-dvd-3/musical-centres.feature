# language:ru
# encoding: utf-8
Функционал: Электроника и техника -> Аудио, Видео -> Проигрыватели и музыкальные центры

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Электроника и техника -> Аудио, Видео -> Проигрыватели и музыкальные центры"
...
@customfield
  Сценарий: Фильтр по типу носителя
    Когда я делаю поиск по следующим параметрам:
      | parameter    | value |
      | Тип носителя | dvd   |
      И на странице поиска загружен список результатов
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Тип носителя" равно "dvd"
