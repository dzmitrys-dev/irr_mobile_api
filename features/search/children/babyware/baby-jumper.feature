# language:ru
# encoding: utf-8
Функционал: Товары для детей -> Товары для малышей -> Ходунки, прыгунки, шезлонги

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Товары для детей -> Товары для малышей -> Ходунки, прыгунки, шезлонги"
...
@customfield
  Сценарий: Фильтр по типу
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Тип" равно "ходунки"
