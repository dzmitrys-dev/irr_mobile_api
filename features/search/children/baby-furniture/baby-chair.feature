# language:ru
# encoding: utf-8
Функционал: Товары для детей -> Детская мебель -> Стульчики для кормления, столы

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Товары для детей -> Детская мебель -> Стульчики для кормления, столы"
