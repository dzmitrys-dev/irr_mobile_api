# language:ru
# encoding: utf-8
Функционал: Фото, оптика -> Фототехника -> Фотоаппараты цифровые

  Контекст:
    Когда открыта страница для города "Москва"
        И на главной странице я перехожу в категорию "Фото, оптика -> Фототехника -> Фотоаппараты цифровые"
...
@customfield
  Сценарий: Фильтр по марке и модели
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Марка" равно "Canon"
       И в деталях первого объявления "Модель" равно "EOS 600D Kit"

@customfield
  Сценарий: Фильтр по типу видеоискателя
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value      |
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Тип видоискателя" равно "оптический"

@customfield
  Сценарий: Фильтр по количеству мегапикселей
   Когда я делаю поиск по следующим параметрам:
      | parameter                   | min | max |
      | Кол-во мегапикселей матрицы | 1   | 20  |
      И на странице поиска загружен список результатов

      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Кол-во мегапикселей матрицы" >= "1"
       И в деталях первого объявления "Кол-во мегапикселей матрицы" <= "20"

@customfield
  Сценарий: Фильтр по количеству мегапикселей
   Когда я делаю поиск по следующим параметрам:
      | parameter                   | max      |
      | Кол-во мегапикселей матрицы | 10000000 |
      И на странице поиска загружен список результатов
