# language:ru
# encoding: utf-8
Функционал: Одежда, обувь, аксессуары -> Аксессуары -> Наручные часы

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Одежда, обувь, аксессуары -> Аксессуары -> Наручные часы"
...
@customfield
  Сценарий: Фильтр по механизму
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Механизм" равно "механические"
