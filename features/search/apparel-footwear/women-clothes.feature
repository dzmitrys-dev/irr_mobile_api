# language:ru
# encoding: utf-8
Функционал: Одежда, обувь, аксессуары -> Женская одежда

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Одежда, обувь, аксессуары -> Женская одежда"
...
@customfield
  Сценарий: Фильтр по виду одежды
   Когда я делаю поиск по следующим параметрам:
      | parameter  | value                    |
      | Вид одежды | платья, сарафаны, туники |
      И на странице поиска загружен список результатов

      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Вид одежды" равно "платья, сарафаны, туники"
...
@customfield
  Сценарий: Фильтр по размеру
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Размеры" содержит "48"
