# language:ru
# encoding: utf-8
Функционал: Одежда, обувь, аксессуары -> Мужская обувь

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Одежда, обувь, аксессуары -> Мужская обувь"
...
@customfield
  Сценарий: Фильтр по виду обуви
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Вид обуви" равно "туфли"
...
@customfield
  Сценарий: Фильтр по размеру
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Размеры" содержит "43"
...
@customfield
  Сценарий: Фильтр по материалу
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Материал" равно "замша"

@customfield
  Сценарий: Фильтр по сезонность
   Когда я делаю поиск по следующим параметрам:
      | parameter  | value  |
      | Сезонность | зимняя |
      И на странице поиска загружен список результатов
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Сезонность" равно "зимняя"
