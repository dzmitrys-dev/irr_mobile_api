# language:ru
# encoding: utf-8
Функционал: Одежда, обувь, аксессуары -> Женская обувь

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Одежда, обувь, аксессуары -> Женская обувь"
...
@customfield
  Сценарий: Фильтр по размеру
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Размеры" содержит "36"
