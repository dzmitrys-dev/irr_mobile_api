# language:ru
# encoding: utf-8
Функционал: Одежда, обувь, аксессуары -> Всё для свадьбы -> Аксессуары для невесты

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Одежда, обувь, аксессуары -> Всё для свадьбы -> Аксессуары для невесты"
...
@customfield
  Сценарий: Фильтр по виду аксессуара
   Когда я делаю поиск по следующим параметрам:
      | parameter      | value   |
      | Вид аксессуара | сумочки |
      И на странице поиска загружен список результатов

      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Вид аксессуара" равно "сумочки"
