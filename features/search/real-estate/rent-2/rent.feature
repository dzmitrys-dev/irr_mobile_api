...
Функционал: Недвижимость -> Квартиры. Аренда
  ...
  Контекст:
    Когда открыта страница для города "Москва"
        И на главной странице я перехожу в категорию "Недвижимость -> Квартиры. Аренда"
...
@customfield
  Сценарий: Фильтр по комнатам в квартире
    Когда я делаю поиск по следующим параметрам:
      | parameter          | value  |
      | Комнат в квартире  | четыре |
      И на странице поиска загружен список результатов для недвижимости

      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Комнат в квартире" равно "4"
...
@customfield
  Сценарий: Фильтр по комнатам в квартире (два и три)
    Когда я делаю поиск по следующим параметрам:
      | parameter          | value      |
      | Комнат в квартире  | три,четыре |
      И на странице поиска загружен список результатов для недвижимости

      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Комнат в квартире" равно одному из "3, 4"
  ...
  Сценарий: Фильтр по общей площади
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       ...
       И в деталях первого объявления "Общая площадь" <= "500"

@customfield
  Сценарий: Фильтр по общей площади
    Когда я делаю поиск по следующим параметрам:
        | parameter     | max       |
        | Общая площадь | 100000000 |
       И на странице поиска загружен список результатов для недвижимости
  ...
  Сценарий: Фильтр по цене
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       ...
       И в каждом объявлении срок сдачи равен "месяц"
