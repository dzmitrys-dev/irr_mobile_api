# language:ru
# encoding: utf-8
Функционал: Недвижимость -> Спрос -> Коммерческая

  Контекст:
    Когда открыта страница для города "Москва"
        И на главной странице я перехожу в категорию "Недвижимость -> Спрос -> Коммерческая"
...
@customfield
  Сценарий: Фильтр по типу объекта
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Тип объекта" равно "офисы"
