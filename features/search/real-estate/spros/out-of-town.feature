# language:ru
# encoding: utf-8
Функционал: Недвижимость -> Спрос -> Загородная

  Контекст:
    Когда открыта страница для города "Москва"
        И на главной странице я перехожу в категорию "Недвижимость -> Спрос -> Загородная"
...
@customfield
  Сценарий: Фильтр по типу объекта
    Когда я делаю поиск по следующим параметрам:
      | parameter   | value     |
      | Тип объекта | дом, дача |
      И на странице поиска загружен список результатов для недвижимости

      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Тип объекта" равно "дом, дача"

@customfield
  Сценарий: Фильтр по коттеджному поселку
    Когда я делаю поиск по следующим параметрам:
      | parameter            | value |
      | В коттеджном поселке | x     |
      И на странице поиска загружен список результатов для недвижимости

      То на странице показано >= 1 объявлений
       И в деталях первого объявления присутствует "В коттеджном поселке"
