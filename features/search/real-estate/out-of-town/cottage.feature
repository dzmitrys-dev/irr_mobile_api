# language:ru
# encoding: utf-8
Функционал: Недвижимость -> Дома, дачи, участки. Продажа -> Коттеджные поселки

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Недвижимость -> Дома, дачи, участки. Продажа -> Коттеджные поселки"
...
@customfield
  Сценарий: Фильтр по площади дома
    Когда я делаю поиск по следующим параметрам:
        | parameter    | min | max  |
        | Площадь дома | 100 | 1000 |
       И на странице поиска загружен список результатов для недвижимости

      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Площадь строения" >= "100"
       И в деталях первого объявления "Площадь строения" <= "1000"

@customfield
  Сценарий: Фильтр по площади дома
    Когда я делаю поиск по следующим параметрам:
        | parameter    | max     |
        | Площадь дома | 1000000 |
       И на странице поиска загружен список результатов для недвижимости
