# language:ru
# encoding: utf-8
Функционал: Спорт, туризм, отдых -> Фитнес, атлетика, борьба -> Тренажеры, спорткомплексы

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Спорт, туризм, отдых -> Фитнес, атлетика, борьба -> Тренажеры, спорткомплексы"
...
@customfield
  Сценарий: Фильтр по типу тренажера
   Когда я делаю поиск по следующим параметрам:
      | parameter     | value         |
      | Тип тренажера | велотренажеры |
      И на странице поиска загружен список результатов

      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Тип тренажера" равно "велотренажеры"
