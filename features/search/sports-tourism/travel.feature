# language:ru
# encoding: utf-8
Функционал: Спорт, туризм, отдых -> Экскурсии, туры, круизы

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Спорт, туризм, отдых -> Экскурсии, туры, круизы"
...
@customfield
  Сценарий: Фильтр по виду отдыха
   Когда я делаю поиск по следующим параметрам:
      | parameter  | value |
      | Вид отдыха | туры  |
      И на странице поиска загружен список результатов
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Вид отдыха" равно "туры"
