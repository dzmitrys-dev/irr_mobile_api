# language:ru
# encoding: utf-8
Функционал: Телефоны и связь -> Для дома и офиса -> Стационарные телефоны

  Контекст:
    Когда открыта страница для города "Москва"
        И на главной странице я перехожу в категорию "Телефоны и связь -> Для дома и офиса -> Стационарные телефоны"
...
@customfield
  Сценарий: Фильтр по марке
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Марка" равно "Panasonic"
