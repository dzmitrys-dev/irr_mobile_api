# language:ru
# encoding: utf-8
Функционал: Телефоны и связь -> Аксессуары

  Контекст:
    Когда открыта страница для города "Москва"
        И на главной странице я перехожу в категорию "Телефоны и связь -> Аксессуары"
...
@customfield
  Сценарий: Фильтр по типу аксессуара
   Когда я делаю поиск по следующим параметрам:
      | parameter      | value |
      | Тип аксессуара | чехлы |
      И на странице поиска загружен список результатов

      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Тип аксессуара" равно "чехлы"
