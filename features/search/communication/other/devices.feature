# language:ru
# encoding: utf-8
Функционал: Телефоны и связь -> Рации, переговорные устройства

  Контекст:
    Когда открыта страница для города "Москва"
        И на главной странице я перехожу в категорию "Телефоны и связь -> Рации, переговорные устройства"
...
@customfield
@bugs @bug34757
  Сценарий: Фильтр по дальности действия
   Когда я делаю поиск по следующим параметрам:
      | parameter          | value  |
      | Дальность действия | 1-3 км |
      И на странице поиска загружен список результатов

      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Дальность действия" равно "1-3 км"
...
@customfield
  ...
  Сценарий: Фильтр по марке
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Марка" равно "Motorola"
