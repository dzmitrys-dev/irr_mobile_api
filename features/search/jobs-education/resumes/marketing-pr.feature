# language:ru
# encoding: utf-8
Функционал: Работа и образование -> Резюме: поиск работы -> Маркетинг, Реклама, PR

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Работа и образование -> Резюме: поиск работы -> Маркетинг, Реклама, PR"
...
@all_results
  ...
  Сценарий: Фильтр по специализации
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Специализация" содержит "аналитика"
