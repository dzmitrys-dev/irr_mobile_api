# language:ru
# encoding: utf-8
Функционал: Работа и образование -> Вакансии: поиск сотрудников -> Другие сферы деятельности 

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Работа и образование -> Вакансии: поиск сотрудников -> Другие сферы деятельности"
...
@all_results
  ...
  Сценарий: Фильтр по специализации
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Сфера деятельности" равно "Другие сферы деятельности"
