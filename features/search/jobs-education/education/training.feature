# language:ru
# encoding: utf-8
Функционал: Работа и образование -> Образование -> Курсы, семинары, тренинги

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Работа и образование -> Образование -> Курсы, семинары, тренинги"
...
@customfield
  Сценарий: Фильтр по направлению
   Когда я делаю поиск по следующим параметрам:
      | parameter   | value  |
      | Направление | дизайн |
      И на странице поиска загружен список результатов
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Направление" содержит "дизайн"
