# language:ru
# encoding: utf-8
Функционал: Работа и образование -> Образование -> Дошкольное образование

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Работа и образование -> Образование -> Дошкольное образование"
...
@customfield
  Сценарий: Фильтр по занятиям
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Занятия" содержит "логопед"
...
@customfield
  Сценарий: Фильтр по стажу репетиторской деятельности
    ...
    И на странице поиска загружен список результатов
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Стаж" >= "1"
       И в деталях первого объявления "Стаж" <= "100"
