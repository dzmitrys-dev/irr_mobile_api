# language:ru
# encoding: utf-8
Функционал: Книги, учебники, журналы -> Художественная литература

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Книги, учебники, журналы -> Художественная литература"
