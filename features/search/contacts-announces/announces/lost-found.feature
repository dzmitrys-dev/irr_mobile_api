# language:ru
# encoding: utf-8
Функционал: Знакомства и общение -> Сообщения -> Потери и находки

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Знакомства и общение -> Сообщения -> Потери и находки"
