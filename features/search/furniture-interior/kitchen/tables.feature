# language:ru
# encoding: utf-8
Функционал: Мебель, интерьер, обиход -> Мебель для кухни -> Столы, стулья, столовые группы

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Мебель, интерьер, обиход -> Мебель для кухни -> Столы, стулья, столовые группы"
...
@customfield
  Сценарий: Фильтр по предмету мебели
   Когда я делаю поиск по следующим параметрам:
      | parameter      | value |
      | Предмет мебели | столы |
      И на странице поиска загружен список результатов

      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Предмет мебели" равно "столы"

@customfield
  Сценарий: Фильтр по виду стола
   Когда я делаю поиск по следующим параметрам:
      | parameter | value      |
      | Вид стола | раскладные |
      И на странице поиска загружен список результатов

      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Вид стола" равно "раскладные"
...
@customfield
  Сценарий: Фильтр по материалу
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Материал" равно "кожа"

@customfield
  Сценарий: Фильтр по материалу обивки
   Когда я делаю поиск по следующим параметрам:
      | parameter       | value |
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Материал обивки" равно "кожа"
...
@customfield
  Сценарий: Фильтр по глубине
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Глубина, см" >= "10"
