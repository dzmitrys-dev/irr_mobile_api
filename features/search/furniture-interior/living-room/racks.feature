# language:ru
# encoding: utf-8
Функционал: Мебель, интерьер, обиход -> Мебель для гостиной -> Стеллажи, полки, витрины

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Мебель, интерьер, обиход -> Мебель для гостиной -> Стеллажи, полки, витрины"
...
@customfield
  Сценарий: Фильтр по виду
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Вид" равно "стеллажи"
...
@customfield
  Сценарий: Фильтр по цвету
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Цвет" равно "дуб"
  ...
  Сценарий: Фильтр по ширине
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       ...
       И в деталях первого объявления "Ширина, см" <= "500"
  ...
  Сценарий: Фильтр по глубине
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       ...
       И в деталях первого объявления "Глубина, см" <= "500"
