# language:ru
# encoding: utf-8
Функционал: Мебель, интерьер, обиход -> Мягкая мебель -> Кресла, пуфы, банкетки

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Мебель, интерьер, обиход -> Мягкая мебель -> Кресла, пуфы, банкетки"
