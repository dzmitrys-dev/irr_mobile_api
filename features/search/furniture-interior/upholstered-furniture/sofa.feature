# language:ru
# encoding: utf-8
Функционал: Мебель, интерьер, обиход -> Мягкая мебель -> Диваны

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Мебель, интерьер, обиход -> Мягкая мебель -> Диваны"
...
@customfield
  Сценарий: Фильтр по механизму раскладывания
   Когда я делаю поиск по следующим параметрам:
      | parameter              | value      |
      | Механизм раскладывания | еврокнижка |
      И на странице поиска загружен список результатов

      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Механизм раскладывания" равно "еврокнижка"
...
@customfield
  Сценарий: Фильтр по угловым
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Угловой" равно "да"
...
@customfield
  Сценарий: Фильтр по раскладным
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Раскладной" равно "да"
