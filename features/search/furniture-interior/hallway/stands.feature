# language:ru
# encoding: utf-8
Функционал: Мебель, интерьер, обиход -> Мебель для прихожей -> Полки, тумбы для обуви

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Мебель, интерьер, обиход -> Мебель для прихожей -> Полки, тумбы для обуви"
...
@customfield
  Сценарий: Фильтр по виду
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Вид" равно "полки для обуви"
  ...
  Сценарий: Фильтр по ширине
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       ...
       И в деталях первого объявления "Ширина, см" <= "200"
  ...
  Сценарий: Фильтр по глубине
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       ...
       И в деталях первого объявления "Глубина, см" <= "200"
  ...
  Сценарий: Фильтр по высоте
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       ...
       И в деталях первого объявления "Высота, см" <= "200"
