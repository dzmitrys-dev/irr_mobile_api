# language:ru
# encoding: utf-8
Функционал: Мебель, интерьер, обиход -> Товары для уборки дома, бытовая химия

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Мебель, интерьер, обиход -> Товары для уборки дома, бытовая химия"
...
@customfield
  Сценарий: Фильтр по виду
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Вид" равно "бытовая химия"
