...
@customfield
  Сценарий: Фильтр по типу кузова
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Тип кузова" равно "пикап"
...
@customfield
  Сценарий: Фильтр по марке и модели
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Марка" равно "Fiat"
       И в деталях первого объявления "Модель" равно "Ducato"
...
@customfield
  Сценарий: Фильтр по марке и модели
   ...
   Когда на странице поиска я запоминаю следующие поля из деталей объявления:
       ...
       | Марка  |
       | Модель |
      То в результатах поиска присутствует объявление, у которого "Марка" равно "Fiat"
       И в результатах поиска присутствует объявление, у которого "Модель" равно "Ducato"
...
@bugs @bug34183
  Сценарий: Фильтр по ключевому слову в заголовке объявления
    Когда я указываю искать только в заголовках объявления
       ...
       То на странице показано >= 1 объявлений
        И в заголовке каждого объявления содержится "газел"
  ...
  Сценарий: Фильтр по ключевому слову
    Когда я ищу "фиат"
       ...
       То на странице показано >= 1 объявлений
        И в первом объявлении содержится одно из "фиат"
