# language:ru
# encoding: utf-8
Функционал: Все для дачи -> Для бань и саун -> Мебель для бани, сауны

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Все для дачи -> Для бань и саун -> Мебель для бани, сауны"
