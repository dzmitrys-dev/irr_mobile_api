# language:ru
# encoding: utf-8
Функционал: Все для дачи -> Камины, печи -> Камины

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Все для дачи -> Камины, печи -> Камины"
...
@customfield
  Сценарий: Фильтр по расположению
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Расположение" равно "центральное"
