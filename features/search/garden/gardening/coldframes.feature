# language:ru
# encoding: utf-8
Функционал: Все для дачи -> Товары для садоводства -> Теплицы, парники

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Все для дачи -> Товары для садоводства -> Теплицы, парники"
...
@customfield
  Сценарий: Фильтр по виду
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Вид" равно "арочные"
