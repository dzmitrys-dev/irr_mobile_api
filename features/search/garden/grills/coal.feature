# language:ru
# encoding: utf-8
Функционал: Все для дачи -> Грили, мангалы -> Уголь, средства розжига

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Все для дачи -> Грили, мангалы -> Уголь, средства розжига"
