# language:ru
# encoding: utf-8
Функционал: Все для дачи -> Садовая техника -> Снегоуборщики

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Все для дачи -> Садовая техника -> Снегоуборщики"
...
@customfield
  Сценарий: Фильтр по марке
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Марка" равно "CubCadet"
...
@customfield
  Сценарий: Фильтр по типу привода
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Тип привода" равно "колесный"

@customfield
  Сценарий: Фильтр по ширине очистки
    Когда я делаю поиск по следующим параметрам:
      | parameter          | min | max |
      | Ширина очистки, см | 1   | 100 |
      И на странице поиска загружен список результатов

      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Ширина очистки, см" >= "1"
       И в деталях первого объявления "Ширина очистки, см" <= "100"
...
@customfield
  Сценарий: Фильтр по мощности
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Мощность двигателя, л.с." >= "1"
       И в деталях первого объявления "Мощность двигателя, л.с." <= "100"
