# language:ru
# encoding: utf-8
Функционал: Все для дачи -> Садовая техника -> Культиваторы, мотоблоки

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Все для дачи -> Садовая техника -> Культиваторы, мотоблоки"
...
@customfield
  Сценарий: Фильтр по классу
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Вид" равно "мотоблок"
...
@customfield
  Сценарий: Фильтр по мощности
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Мощность, л.с." >= "1"
       И в деталях первого объявления "Мощность, л.с." <= "100"

@customfield
  Сценарий: Фильтр по ширине захвата
    Когда я делаю поиск по следующим параметрам:
      | parameter          | min | max |
      | Ширина захвата, см | 1   | 100 |
      И на странице поиска загружен список результатов

      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Ширина захвата, см" >= "1"
       И в деталях первого объявления "Ширина захвата, см" <= "100"
