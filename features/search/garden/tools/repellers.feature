# language:ru
# encoding: utf-8
Функционал: Все для дачи -> Садовые инструменты, инвентарь -> Средства от насекомых и грызунов

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Все для дачи -> Садовые инструменты, инвентарь -> Средства от насекомых и грызунов"
