# language:ru
# encoding: utf-8
Функционал: Бизнес и партнерство -> Сырье, тара, товары оптом -> Сырье, вторичная переработка

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Бизнес и партнерство -> Сырье, тара, товары оптом -> Сырье, вторичная переработка"
