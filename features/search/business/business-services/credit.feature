# language:ru
# encoding: utf-8
Функционал: Бизнес и партнерство -> Бизнес услуги -> Помощь в получении кредита

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Бизнес и партнерство -> Бизнес услуги -> Помощь в получении кредита"
