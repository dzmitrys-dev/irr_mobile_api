...
@customfield
  Сценарий: Фильтр по сроку существования в бизнесе
    Когда я делаю поиск по следующим параметрам:
      | parameter                       | min | max |
      | Срок существования бизнеса, лет | 1   | 100 |
      И на странице поиска загружен список результатов

      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Срок существования бизнеса, лет" >= "1"
       И в деталях первого объявления "Срок существования бизнеса, лет" <= "100"

@customfield
  Сценарий: Фильтр по сроку существования в бизнесе
    Когда я делаю поиск по следующим параметрам:
      | parameter                       | max |
      | Срок существования бизнеса, лет | 100 |
      И на странице поиска загружен список результатов
