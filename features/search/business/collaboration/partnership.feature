# language:ru
# encoding: utf-8
Функционал: Бизнес и партнерство -> Партнерство и сотрудничество -> Партнерство

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Бизнес и партнерство -> Партнерство и сотрудничество -> Партнерство"
...
@customfield
  Сценарий: Фильтр по сфере деятельности
   Когда я делаю поиск по следующим параметрам:
      | parameter          | value  |
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Сфера деятельности" равно "одежда"

@customfield
  Сценарий: Фильтр по доходу
   Когда я делаю поиск по следующим параметрам:
      | parameter  | min   | max     |
      | Доход, руб | 10000 | 1000000 |
      И на странице поиска загружен список результатов

      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Доход, руб" >= "10000"
       И в деталях первого объявления "Доход, руб" <= "1000000"

@customfield
  Сценарий: Фильтр по доходу
   Когда я делаю поиск по следующим параметрам:
      | parameter  | max        |
      | Доход, руб | 1000000000 |
      И на странице поиска загружен список результатов

      То на странице показано >= 1 объявлений

@customfield
  Сценарий: Фильтр по сроку окупаемости
   Когда я делаю поиск по следующим параметрам:
      | parameter             | min | max |
      | Срок окупаемости, лет | 1   | 90  |
      И на странице поиска загружен список результатов

      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Срок окупаемости, лет" >= "1"
       И в деталях первого объявления "Срок окупаемости, лет" <= "90"

@customfield
  Сценарий: Фильтр по сроку окупаемости
   Когда я делаю поиск по следующим параметрам:
      | parameter             | max       |
      | Срок окупаемости, лет | 90000000  |
      И на странице поиска загружен список результатов
