# language:ru
# encoding: utf-8
Функционал: Строительство и ремонт -> Материалы -> ЖБИ, бетон, кирпич, сухие смеси

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Строительство и ремонт -> Материалы -> ЖБИ, бетон, кирпич, сухие смеси"
...
@customfield
  Сценарий: Фильтр по типу материалу
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Тип материала" равно "бетон"
