# language:ru
# encoding: utf-8
Функционал: Строительство и ремонт -> Инструменты -> Пневмоинструмент

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Строительство и ремонт -> Инструменты -> Пневмоинструмент"
...
@customfield
  Сценарий: Фильтр по марке
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Марка" равно "Hitachi"
...
@customfield
  Сценарий: Фильтр по расходу воздуха
   Когда я делаю поиск по следующим параметрам:
      | parameter             | min | max |
      | Расход воздуха, л/мин | 1   | 100 |
      И на странице поиска загружен список результатов

      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Расход воздуха, л/мин" >= "1"
       И в деталях первого объявления "Расход воздуха, л/мин" <= "100"

@customfield
  Сценарий: Фильтр по расходу воздуха
   Когда я делаю поиск по следующим параметрам:
      | parameter             | max      |
      | Расход воздуха, л/мин | 10000000 |
      И на странице поиска загружен список результатов
  ...
  Сценарий: Фильтр по давлению
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       ...
       И в деталях первого объявления "Давление, бар" <= "100"

@customfield
  Сценарий: Фильтр по давлению
   Когда я делаю поиск по следующим параметрам:
      | parameter     | max     |
      | Давление, бар | 1000000 |
      И на странице поиска загружен список результатов
