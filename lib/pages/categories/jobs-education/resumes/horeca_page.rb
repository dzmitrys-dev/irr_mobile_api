...
class CategoryJobsEducationresumesHorecaPage < AdDetailsPage
  include PageObject

  @@url_suffix = "/jobs-education/resumes/horeca"
  @category = "Работа и образование -> Резюме: поиск работы -> Ресторанный бизнес, фастфуд"
