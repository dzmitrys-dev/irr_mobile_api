...
class CategoryJobsEducationresumesFreelancePage < AdDetailsPage
  include PageObject

  @@url_suffix = "/jobs-education/resumes/freelance"
  @category = "Работа и образование -> Резюме: поиск работы -> Удаленная работа"
