...
class CategoryJobsEducationresumesTourismPage < AdDetailsPage
  include PageObject

  @@url_suffix = "/jobs-education/resumes/tourism"
  @category = "Работа и образование -> Резюме: поиск работы -> Туризм, гостиничное дело"
