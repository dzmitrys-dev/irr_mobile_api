...
class CategoryJobsEducationresumesLogisticsPage < AdDetailsPage
  include PageObject

  @@url_suffix = "/jobs-education/resumes/logistics"
  @category = "Работа и образование -> Резюме: поиск работы -> Логистика, склад, ВЭД"
