...
class CategoryJobsEducationresumesProductionPage < AdDetailsPage
  include PageObject

  @@url_suffix = "/jobs-education/resumes/production"
  @category = "Работа и образование -> Резюме: поиск работы -> Промышленность, производство"
