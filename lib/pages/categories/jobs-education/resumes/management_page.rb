...
class CategoryJobsEducationresumesManagementPage < AdDetailsPage
  include PageObject

  @@url_suffix = "/jobs-education/resumes/management"
  @category = "Работа и образование -> Резюме: поиск работы -> Руководители"
