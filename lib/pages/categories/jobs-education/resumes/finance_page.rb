...
class CategoryJobsEducationresumesFinancePage < AdDetailsPage
  include PageObject

  @@url_suffix = "/jobs-education/resumes/finance"
  @category = "Работа и образование -> Резюме: поиск работы -> Финансы, бухгалтерия, банк"
