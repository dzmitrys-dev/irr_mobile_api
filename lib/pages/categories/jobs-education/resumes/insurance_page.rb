...
class CategoryJobsEducationresumesInsurancePage < AdDetailsPage
  include PageObject

  @@url_suffix = "/jobs-education/resumes/insurance"
  @category = "Работа и образование -> Резюме: поиск работы -> Страхование"
