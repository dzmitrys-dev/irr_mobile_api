...
class CategoryJobsEducationresumesBeautyPage < AdDetailsPage
  include PageObject

  @@url_suffix = "/jobs-education/resumes/beauty"
  @category = "Работа и образование -> Резюме: поиск работы -> Красота, фитнес, спорт"
