...
class CategoryJobsEducationresumesEducationPage < AdDetailsPage
  include PageObject

  @@url_suffix = "/jobs-education/resumes/education"
  @category = "Работа и образование -> Резюме: поиск работы -> Образование, наука, культура"
