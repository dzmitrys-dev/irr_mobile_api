...
class CategoryJobsEducationresumesAssistancePage < AdDetailsPage
  include PageObject

  @@url_suffix = "/jobs-education/resumes/assistance"
  @category = "Работа и образование -> Резюме: поиск работы -> Обслуживающий персонал, секретариат, АХО"
