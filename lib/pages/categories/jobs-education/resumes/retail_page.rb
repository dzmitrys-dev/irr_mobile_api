...
class CategoryJobsEducationresumesRetailPage < AdDetailsPage
  include PageObject

  @@url_suffix = "/jobs-education/resumes/retail"
  @category = "Работа и образование -> Резюме: поиск работы -> Продажи"
