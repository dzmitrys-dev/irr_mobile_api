...
class CategoryJobsEducationresumesSecurityPage < AdDetailsPage
  include PageObject

  @@url_suffix = "/jobs-education/resumes/security"
  @category = "Работа и образование -> Резюме: поиск работы -> Охрана, безопасность"
