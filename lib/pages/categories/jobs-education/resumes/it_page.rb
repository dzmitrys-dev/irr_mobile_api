...
class CategoryJobsEducationresumesITPage < AdDetailsPage
  include PageObject

  @@url_suffix = "/jobs-education/resumes/it"
  @category = "Работа и образование -> Резюме: поиск работы -> Информационные технологии и интернет"
